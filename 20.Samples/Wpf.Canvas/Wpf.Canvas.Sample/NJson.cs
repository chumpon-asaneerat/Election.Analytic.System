    ...
    public static class NJson
    {
        ...
        public static string LocalDataFolder
        {
            get
            {
                ...
                string localFilder = Path.Combine(
                    Path.GetDirectoryName(assem.Location), "data");
                if (!Directory.Exists(localFilder))
                {
                    Directory.CreateDirectory(localFilder);
                }
                return localFilder;
            }
        }
        ...
        public static string LocalConfigFolder
        {
            get
            {
                ...
                Assembly assem = Assembly.GetExecutingAssembly();
                string localFilder = Path.Combine(
                    Path.GetDirectoryName(assem.Location), "Configs");
#else
        ...
        {
            return Path.Combine(NJson.LocalDataFolder, fileName);
        }
        /// <summary>
        ...
        {
            return Path.Combine(NJson.LocalConfigFolder, fileName);
        }
        /// <summary>
