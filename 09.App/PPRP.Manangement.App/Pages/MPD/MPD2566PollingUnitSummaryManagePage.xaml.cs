...
namespace PPRP.Pages
{
    ...
    public partial class MPD2566PollingUnitSummaryManagePage : UserControl
    {
        ...
        private void Export()
        {
            var items = MPD2566PollingUnitSummary.Gets().Value;
            if (null == items)
            {
                // Show Dialog.
                return;
            ...
            if (export.ShowDialog("ข้อมูลการเขตเลือกตั้งปี 2566.xlsx"))
            {
                ...
                if (export.Save(items, "หน่วยเลือกตั้งแบบแบ่งเขต 2566"))
                {
        ...
        private void RefreshList()
        {
            ...
            var summaries = MPD2566PollingUnitSummary.Gets(provinceName);
