...
{
    /// <summary>
    /// Interaction logic for ImportMPD2562PollingUnitSummaryWindow.xaml
    /// </summary>
    public partial class ImportMPD2562PollingUnitSummaryWindow : Window
    {
        #region Constructor
        ...
        /// Constructor.
        /// </summary>
        public ImportMPD2562PollingUnitSummaryWindow()
        {
            InitializeComponent();
        }
        ...
        private void Imports()
        {
            if (null != items && items.Count > 0)
            {
                ...
                {
                    MPD2562PollingUnitSummary.Import(item);
                    prog.Increment();
                }
